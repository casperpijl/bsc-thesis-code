# Cumulative prompt (gemma4-31b, level 5)

## System prompt

For mixtures, track solvent combinations and their respective mole, volume, or mass fractions. Follow the order presented in the tables while extracting data.
