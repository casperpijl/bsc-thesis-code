...
- For concentration units (`units.concentration_1`, `units.concentration_2`), determine the type of fraction based on the context provided in the paper. Common notations: "w" typically denotes mass fraction, "x" typically denotes mole fraction. The concentration values should correspond to the unit type you specify in the units field.
